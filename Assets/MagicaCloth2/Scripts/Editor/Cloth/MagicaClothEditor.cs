...
namespace MagicaCloth2
{
    ...
    public class MagicaClothEditor : Editor
    {
        ...
        private bool filterColorChange = false;
        private Color32 templateChangeColor;
            ...
            // Cloth
            {
                ...
                using (new EditorGUI.IndentLevelScope())
                {
                    ...
                    else if (cloth.SerializeData.clothType == ClothProcess.ClothType.MeshCloth)
                    {
                        ...
                        if (!filterColorChange)
                        {
                            templateChangeColor = cloth.GetSerializeData2().filterColor;
                        }
                        templateChangeColor = EditorGUILayout.ColorField("顶点色过滤:", templateChangeColor);
                        if (EditorGUI.EndChangeCheck())
                        {
                            filterColorChange = true;
                        }
                        if (filterColorChange )
                        {
                            ...
                            {
                                filterColorChange = false;
                                cloth.ClearSerializeData2();
                                cloth.GetSerializeData2().filterColor = templateChangeColor;
                                ClothEditorManager.RegisterComponent(cloth, 0, true);
                            }
                        ...
                        if (GUILayout.Button("Refresh Model"))
                        {
                            cloth.GetSerializeData2().filteredToOrigin = null;
                            ClothEditorManager.RegisterComponent(cloth, 0, true);
                        }
